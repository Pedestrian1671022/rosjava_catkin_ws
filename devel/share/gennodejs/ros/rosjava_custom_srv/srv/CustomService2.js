...
class CustomService2Request {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CustomService2Request
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CustomService2Request
    let len;
    let data = new CustomService2Request(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CustomService2Request(null);
    if (msg.a !== undefined) {
      resolved.a = msg.a;
    }
    else {
...
class CustomService2Response {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CustomService2Response
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CustomService2Response
    let len;
    let data = new CustomService2Response(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CustomService2Response(null);
...
module.exports = {
  Request: CustomService2Request,
  Response: CustomService2Response,
  md5sum() { return 'f0b6d69ea10b0cf210cb349d58d59e8f'; },
  datatype() { return 'rosjava_custom_srv/CustomService2'; }
};
